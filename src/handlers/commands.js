...
• Оформлять скриншоты в стильные mockup-и
• Работать в inline-режиме (быстро!)

📝 Доступные команды:
/link - Создать share-ссылку
/screenshot - Оформить скриншот
...
1. Отправьте команду /screenshot
2. Пришлите скриншот
3. Выберите стиль:
   🖥️ Mac Window — окно macOS
   📱 iPhone — мокап iPhone
   📚 Layered — многослойный эффект
4. Выберите градиент фона
5. Получите готовый красивый mockup!
